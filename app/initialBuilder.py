...
def N7_Form(lf_name: str, ll_name: str, l_street: str, l_unit: str,
  ...
  fieldsStrings = f"0;form1[0].#subform[0].Notice_Name_and_Address[0].TO_TenameName[0];{t_name}|0;form1[0].#subform[0].Notice_Name_and_Address[0].From_LandlordName[0];{l_name}|0;form1[0].#subform[0].Notice_Name_and_Address[0].RentalUnitAddress[0];{t_street}|1;form1[0].#subform[4].Signature_for_Notice[0].Signature[0];{l_name}|1;form1[0].#subform[4].Signature_for_Notice[0].RFirstName[0];{lf_name}|1;form1[0].#subform[4].Signature_for_Notice[0].RLastName[0];{ll_name}"
